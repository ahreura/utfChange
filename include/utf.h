...
//kat
void callwrite(code_point_t code_point, int outfile);
...
convertion_func_t get_encoding_function(int infile, int outfile);
...
void utf16_glyph_to_code_point(utf16_glyph_t *glyph, int infile, int outfile);
void utf16le_glyph_to_code_point(utf16_glyph_t *glyph, int infile, int outfile);
